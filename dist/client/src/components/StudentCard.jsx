...
export default function StudentCard({ student }) {
    return (<Card className="bg-gray-50">
      <CardContent className="p-6 text-center">
        <img src={student.image} alt={student.name} className="w-24 h-24 rounded-full mx-auto mb-4 object-cover"/>
        ...
        <Badge className={achievementColors[student.achievement] || "bg-gray-100 text-gray-800"}>
          {student.achievement}
        </Badge>
