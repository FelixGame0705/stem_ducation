...
export default function Home() {
    ...
    const programs = (programsData === null || programsData === void 0 ? void 0 : programsData.programs) || [];
    const students = (studentsData === null || studentsData === void 0 ? void 0 : studentsData.students) || [];
    const featuredNews = (newsData === null || newsData === void 0 ? void 0 : newsData.news) || [];
    return (<div className="min-h-screen">
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {programsLoading ? (<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {[...Array(6)].map((_, i) => (<div key={i} className="bg-white rounded-xl p-6 animate-pulse">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {studentsLoading ? (<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {[...Array(3)].map((_, i) => (<div key={i} className="bg-gray-50 rounded-xl p-6 animate-pulse">
              ...
              {students.slice(0, 3).map((student) => (<StudentCard key={student.id} student={student}/>))}
            </div>)}
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {newsLoading ? (<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {[...Array(3)].map((_, i) => (<div key={i} className="bg-white rounded-xl overflow-hidden animate-pulse">
