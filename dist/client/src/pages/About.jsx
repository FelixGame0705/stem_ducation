      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {teachers.map((teacher, index) => (<Card key={index}>
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {facilities.map((facility, index) => (<Card key={index}>
                <CardContent className="p-6">
                  <img src={facility.image} alt={facility.name} className="w-full h-48 object-cover rounded-lg mb-4"/>
