          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input id="username" {...register("username")} placeholder="Nhập tên đăng nhập" className="pl-10"/>
              </div>
              {errors.username && (<p className="text-sm text-red-600">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input id="password" type="password" {...register("password")} placeholder="Nhập mật khẩu" className="pl-10"/>
              </div>
