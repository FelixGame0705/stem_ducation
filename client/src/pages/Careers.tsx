                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                  <div className="lg:col-span-2">
                    <div className="flex flex-wrap items-center gap-2 mb-4">
                      <Badge 
                        className={
                          job.type === "Toàn thời gian" || job.type === "full-time"
                  ...
                  <div className="flex flex-col justify-center">
                    ...
                    {job.url ? (
                      <Button asChild variant="outline" className="border-ocean-blue text-ocean-blue hover:bg-ocean-blue hover:text-white">
                        <a href={job.url} target="_blank" rel="noopener noreferrer">Tìm hiểu thêm</a>
                      </Button>
                    ) : (
                      <Button variant="outline" className="border-ocean-blue text-ocean-blue hover:bg-ocean-blue hover:text-white" disabled>
                        Tìm hiểu thêm
                      </Button>
                    )}
                  </div>
