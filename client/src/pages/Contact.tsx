              ...
              <CardContent>
                <Form {...form}>
                  <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                        ...
                        <FormItem>
                          ...
                          <FormControl>
                            <Textarea 
                              ...
                              rows={6}
                              {...field}
                              className={fieldState.invalid ? 'border-red-500 focus:border-red-500 focus:ring-red-500' : ''}
                            />
                          </FormControl>
                          <FormMessage />
                        </FormItem>
                    ...
                    <Button
                      type="submit"
                      className="bg-blue-600 text-white hover:bg-blue-700 w-full cursor-pointer transition-transform"
